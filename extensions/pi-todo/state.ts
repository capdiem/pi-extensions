...
/** True when any task is currently in_progress. Used by the reconcile nudge to
 *  decide whether a run-end reminder is warranted. */
export function hasInProgress(state: TodoState): boolean {
